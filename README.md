...
### Publications
- **ICASSP 2026** - *PC-MCL: Patient-Consistent Multi-Cycle Learning With Multi-Label Bias Correction for Respiratory Sound Classification* (SG Jeong, SE Kim)
...
- **arXiv preprint 2025 (DCASE 2025 Task1)** - *Adaptive Knowledge Distillation using a Device-Aware Teacher for Low-Complexity Acoustic Scene Classification* (SG Jeong, SE Kim)
- **ITC-CSCC 2024** - *Patient Domain Supervised Contrastive Learning for Lung Sound Classification Using Mobile Phone* (SG Jeong, SE Kim)
- **한국전기전자학회 학술대회, 2025 (우수논문상)** - *오디오 분리 기법을 이용한 스마트폰 기반 폐음 분류의 소음강건성 향상 연구* (정승규, 김성은)
